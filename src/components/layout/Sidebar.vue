<template>
  <div>
    <b-list-group>
      ...
      <b-list-group-item v-if="tokenUserRole !== '팀원'" href="#" @click="onClick('/department')">부서 관리</b-list-group-item>
      <b-list-group-item v-if="tokenUserRole !== '팀원'" href="#" @click="onClick('/user')">사용자 관리</b-list-group-item>
